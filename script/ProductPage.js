...
function addItem(obj) {
    ...
    divForDescription.appendChild(Title)
    divForDescription.appendChild(Rating)
    divForDescription.appendChild(Price)
    divForDescription.appendChild(Color)
    divForDescription.appendChild(Size)
    divForDescription.appendChild(Buttons)
    divForDescription.appendChild(Media)
    divForDescription.appendChild(Shopping)

    div_description.appendChild(divForImg)
    div_description.appendChild(divForDescription)
